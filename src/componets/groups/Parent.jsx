  ...
  return (
    <div>
      <nav className="bg-blue-800 text-cyan-50">
        <ul className="cursor-pointer flex flex-wrap justify-center items-center gap-6 py-3 md:py-4 lg:py-5 sm:gap-4 md:gap-6 lg:gap-8">
          <li onClick={() => gotoHome()} className="truncate">
            Home
          </li>
          <li onClick={() => fetchDays(0)} className="truncate">
            Today
          </li>
          <li onClick={() => fetchDays(1)} className="truncate">
            Previous Day
          </li>
          <li onClick={() => fetchDays(7)} className="truncate">
            Last 7 days
          </li>
          <li onClick={() => fetchDays(30)} className="truncate">
            Last 30 Days
          </li>
